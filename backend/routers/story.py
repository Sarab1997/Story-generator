...
def generate_story_task(job_id: str, theme: str, session_id: str):
    ...
    Creates its own database session to avoid connection pool exhaustion.
    """
    db = SessionLocal()
    ...
    try:
        ...
        try:
            ...
            # StoryGenerator now manages its own session internally
            # Don't pass db to it
            story = StoryGenerator.generate_story(session_id=session_id, theme=theme)
